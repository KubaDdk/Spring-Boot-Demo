    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
                ...
                <p class="mb-4">All users from our class - SDA | <a
                            ...
                            <table class="table action-panel table-bordered" id="dataTable" cellspacing="0">
                                ...
                                <c:forEach items="${person}" var="title">
                                    <tr>
                                        ...
                                        <td><a href='<c:url value="${title.firstName}"/>' class="btn btn-info btn-circle">
                                                                <i class="fas fa-info-circle"></i>
                                                              </a></td>
                                         <td>${title.start}</td>
                                        <td>
                                            <c:if test="${title.checkbox eq '1'}">
                                            <a href="#" role="button" class="btn btn-success btn-circle" data-toggle="modal" data-target="#umiejetnosci_${title.id}"><i class="fas
                                        fa-check"></i></a></td>
                                            </c:if>
                                        <c:if test="${title.checkbox eq '0'}">
                                           Nothing
                                        </c:if>
                ...
                <!-- The Modal -->
<div class="modal" id="umiejetnosci_${title.id}">
        ...
        <div class="modal-body">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <h4 class="small
              font-weight-bold">Design patterns
               <span
